...
public class IndividualCustomerManager implements IndividualCustomerService{
	...
	@Autowired
	public IndividualCustomerManager(ModelMapperService modelMapperService, IndividualCustomerRepository individualCustomerRepository,EmailService emailService,ActivationCodeService activationCodeService,MernisService mernisService) {
		super();
